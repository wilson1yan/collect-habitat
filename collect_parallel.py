...
def worker(i, args):
    ...
    cmd = f'python collect.py -l {args.traj_length} -r {args.resolution} --output {output_dir} --n_traj {args.n_traj}'
    os.system(cmd)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-n', '--n_traj', type=int, default=10) # per worker per env so total is n_traj * # workers * # envs
